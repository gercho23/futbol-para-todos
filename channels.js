...
const channels = [
  ...
  { id:'espn',            name:'ESPN 1',            icon:'E1', color:'#e53e3e', region:'arg', logo: LOGOS.espn,
    customSources: [
      ...
      { url: 'https://cdn.cvattv.com.ar/live/c3eds/ESPN2HD/SA_Live_dash_enc_C/ESPN2HD.mpd', type: 'dash', keyId: 'e884b711ab111beb8a7ba1e7bcbdc9bf', keyValue: 'cb89ee3961599e3e648a5aad60895f34' },
  ...
  { id:'espnpremium',     name:'ESPN Premium',      icon:'EP', color:'#c53030', region:'arg', logo: LOGOS.espnpremium,
    customSources: [
      ...
      { url: 'https://streamtp-golden1.click/global1.php?stream=espnpremium', type: 'iframe' },
  ...
  { id:'dsports',         name:'DSports',           icon:'DS', color:'#6b46c1', region:'arg', logo: LOGOS.dsports,
    customSources: [
      ...
      { url: 'https://streamxhd.click/channel/?id=dsports', type: 'iframe' },
      { url: 'https://streamxhd.com/live1.php?stream=dsportsar', type: 'iframe' },
    ]},
