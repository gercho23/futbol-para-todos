...
const LOGOS = {
  ...
  win:      'https://upload.wikimedia.org/wikipedia/commons/5/58/Win_Sports_nuevo_logo.svg',
  telefe:   'https://upload.wikimedia.org/wikipedia/commons/c/c5/Logo_telefe_argentina.svg',
  ...
  azteca7:  'https://upload.wikimedia.org/wikipedia/commons/2/2a/Azteca72024.png',
  canal5:   'https://upload.wikimedia.org/wikipedia/commons/1/1d/Canal_5_Mexico_logo_2014.svg',
  ...
  laliga:   'https://upload.wikimedia.org/wikipedia/commons/8/8b/LaLiga_TV_Hypermotion_2023_Logo.svg',
  tigo:     'https://upload.wikimedia.org/wikipedia/commons/3/3b/Tigo_Sports_2025.png',
  futv:     'https://upload.wikimedia.org/wikipedia/commons/a/ae/Logo_de_FUTV.svg',
  tn:       'https://upload.wikimedia.org/wikipedia/commons/4/4f/TN_todo_noticias_logo.svg',
  trece:    'https://upload.wikimedia.org/wikipedia/commons/8/8d/Isotipo_eltrece_2016.png',
  bein:     'https://upload.wikimedia.org/wikipedia/commons/d/d4/BeIN_Sports_logo_%28horizontal_version%29.svg',
  bein_es:  'https://upload.wikimedia.org/wikipedia/commons/0/04/BeIN_Sports_En_Espa%C3%B1ol.png',
  bein_xtra_logo:'https://mma.prnewswire.com/media/1610429/beIN_SPORTS_XTRA_Logo.jpg',
  bein1logo:'https://upload.wikimedia.org/wikipedia/commons/d/d4/BeIN_Sports_logo_%28horizontal_version%29.svg',
  bein2logo:'https://upload.wikimedia.org/wikipedia/commons/1/14/BeIN_SPORTS_HD2_logo.png',
  ...
  itvdep:   'https://upload.wikimedia.org/wikipedia/commons/6/62/ITV_logo.svg',
  fastwomen:'https://upload.wikimedia.org/wikipedia/commons/3/3a/Tubi_logo_2024.svg',
  cartoon:  'https://upload.wikimedia.org/wikipedia/commons/8/80/Cartoon_Network_2010_logo.svg',
  ...
  nick:     'https://upload.wikimedia.org/wikipedia/commons/7/7a/Nickelodeon_2009_logo.svg',
  ...
  deportv:  'https://upload.wikimedia.org/wikipedia/commons/0/0c/Deportv.svg',
  ...
  a24:      'https://upload.wikimedia.org/wikipedia/commons/5/5b/A24_%282025%29.svg',
  c5n:      'https://upload.wikimedia.org/wikipedia/commons/0/07/C5N_logo.svg',
  cronica:  'https://upload.wikimedia.org/wikipedia/commons/f/fb/Cr%C3%B3nica_TV_logotipo_%282016%29.png',
  america:  'https://upload.wikimedia.org/wikipedia/commons/9/99/Logotipo_de_America_TV.svg',
  nueve:    'https://upload.wikimedia.org/wikipedia/commons/3/3a/Canal_9_2015.png',
  adultswim:'https://upload.wikimedia.org/wikipedia/commons/e/e4/Adult_Swim_2003_logo.svg',
  hbo:      'https://upload.wikimedia.org/wikipedia/commons/d/de/HBO_logo.svg',
  sony:     'https://upload.wikimedia.org/wikipedia/commons/4/42/Sony_Channel_logo.svg',
  axn:      'https://upload.wikimedia.org/wikipedia/commons/a/a0/AXN_logo.svg',
  ...
  cinemax:  'https://upload.wikimedia.org/wikipedia/commons/d/d1/Cinemax.svg',
  fx:       'https://upload.wikimedia.org/wikipedia/commons/4/4d/FX_International_logo.svg',
  tnt_ent:  'https://upload.wikimedia.org/wikipedia/commons/e/ec/TNT_%28TV_Channel%29.svg',
...
const channels = [
  ...
  { id:'espn',            name:'ESPN 1',            icon:'E1', color:'#e53e3e', region:'arg', logo: LOGOS.espn,
    customSources: [
      ...
      { url: 'https://pcn.nebunexa.life/cvatt.html?get=RVNQTjJIRA&lang=1', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=espn', type: 'iframe' },
  ...
  { id:'espn3',           name:'ESPN 3',            icon:'E3', color:'#e53e3e', region:'arg', logo: LOGOS.espn,
    customSources: [
      ...
      { url: 'https://pcn.nebunexa.life/cvatt.html?get=RVNQTjM&lang=1', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=espn3', type: 'iframe' },
    ]},
  { id:'espn4',           name:'ESPN 4',            icon:'E4', color:'#e53e3e', region:'arg', logo: LOGOS.espn,
    customSources: [
      ...
      { url: 'https://pcn.nebunexa.life/cvatt.html?get=RVNQTkhE&lang=1', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=espn4', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=espn4ar', type: 'iframe' },
    ]},
  { id:'espn5',           name:'ESPN 5',            icon:'E5', color:'#e53e3e', region:'arg', logo: LOGOS.espn,
    customSources: [
      ...
      { url: 'https://pcn.nebunexa.life/cvatt.html?get=RVNQTjQ=&lang=1', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=espn5', type: 'iframe' },
    ]},
  { id:'espn6',           name:'ESPN 6',            icon:'E6', color:'#e53e3e', region:'arg', logo: LOGOS.espn,
    customSources: [
      ...
      { url: 'https://pcn.nebunexa.life/cvatt.html?get=Rm94U3BvcnRzM19VWQ==&lang=1', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=espn6', type: 'iframe' },
    ]},
  { id:'espn7',           name:'ESPN 7',            icon:'E7', color:'#e53e3e', region:'arg', logo: LOGOS.espn,
    customSources: [
      ...
      { url: 'https://pcn.nebunexa.life/cvatt.html?get=Rm94U3BvcnRzMl9VWQ==&lang=1', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=espn7', type: 'iframe' },
    ]},
  ...
  { id:'fox1ar',          name:'Fox Sports 1',      icon:'F1', color:'#2b6cb0', region:'arg', logo: LOGOS.fox ,
    customSources: [
      { url: 'https://streamhdx.com/live1.php?stream=fox1ar', type: 'iframe' },
    ]},
  { id:'fox2ar',          name:'Fox Sports 2',      icon:'F2', color:'#2b6cb0', region:'arg', logo: LOGOS.fox ,
    customSources: [
      { url: 'https://streamhdx.com/live1.php?stream=fox2ar', type: 'iframe' },
    ]},
  { id:'fox3ar',          name:'Fox Sports 3',      icon:'F3', color:'#2b6cb0', region:'arg', logo: LOGOS.fox ,
    customSources: [
      { url: 'https://streamhdx.com/live1.php?stream=fox3ar', type: 'iframe' },
    ]},
  ...
  { id:'dsportsplus',     name:'DSports+',          icon:'D+', color:'#6b46c1', region:'arg', logo: LOGOS.dsports ,
    customSources: [
      { url: 'https://streamhdx.com/live1.php?stream=dsportsplus', type: 'iframe' },
    ]},
  ...
  { id:'tycsports',       name:'TyC Sports',        icon:'TY', color:'#2d6a4f', region:'arg', logo: LOGOS.tyc,
    customSources: [
      ...
      { url: 'https://pcn.nebunexa.life/cvatt.html?get=VHlDU3BvcnQ&lang=1', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=tycsports', type: 'iframe' },
    ]},
  ...
  { id:'winplus2',        name:'Win Sports+ 2',     icon:'W2', color:'#276749', region:'arg', logo: LOGOS.win,
    customSources: [
      ...
      { url: 'https://streamx339.cloud/global1.php?channel=winplus2', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=winplus2', type: 'iframe' },
    ]},
  { id:'winsports',       name:'Win Sports',        icon:'WN', color:'#276749', region:'arg', logo: LOGOS.win,
    customSources: [
      ...
      { url: 'https://streamx339.cloud/global1.php?channel=winsports', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=winsports', type: 'iframe' },
    ]},
  { id:'telefe',          name:'Telefe',            icon:'TF', color:'#744210', region:'arg', logo: LOGOS.telefe,
    customSources: [
      ...
      { url: 'https://pelisjuanita.com/tv/telefe.html', type: 'iframe' },
          { url: 'https://streamhdx.com/live1.php?stream=telefe', type: 'iframe' },
    ]},
  ...
  { id:'espndeportes',    name:'ESPN Deportes',     icon:'ED', color:'#e53e3e', region:'usa', logo: LOGOS.espn ,
    customSources: [
      { url: 'https://streamhdx.com/live1.php?stream=espndeportes', type: 'iframe' },
    ]},
  ...
  { id:'bein_xtra_es',    name:'beIN Sports Xtra ES',icon:'BE', color:'#1a365d', region:'int', logo: LOGOS.bein_xtra_logo,
    customSources: [
  ...
  { id:'bein2',           name:'beIN Sports 2',    icon:'B2', color:'#1a365d', region:'int', logo: LOGOS.bein2logo,
    customSources: [
      { url: 'https://esvideofy.com/ote.php?id=bs2', type: 'iframe' },
    ]},
  ...
  { id:'bein3',           name:'beIN Sports 3',    icon:'B3', color:'#1a365d', region:'int', logo: LOGOS.bein3logo,
    customSources: [
      { url: 'https://esvideofy.com/ote.php?id=bs3', type: 'iframe' },
