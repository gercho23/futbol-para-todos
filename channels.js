...
const channels = [
  ...
  { id:'espnpremium',     name:'ESPN Premium',      icon:'EP', color:'#c53030', region:'arg', logo: LOGOS.espnpremium,
    customSources: [
      { url: 'https://bestleague.top/cvattc.html?get=Rm94X1Nwb3J0c19QcmVtaXVuX0hE&lang=1', type: 'iframe' },
  ...
  { id:'telefe',          name:'Telefe',            icon:'TF', color:'#744210', region:'arg', logo: LOGOS.telefe,
    customSources: [
      ...
      { url: 'https://mdstrm.com/live-stream-playlist/69e0fb650d9e3eb5340cdd5c.m3u8', type: 'hls' },
    ]},
